  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 bg-background/10 backdrop-blur-md border border-primary/20 cursor-pointer rounded-full group will-change-transform z-50"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-background/10 backdrop-blur-md border border-primary/20 rounded-full will-change-transform"
            style={{
